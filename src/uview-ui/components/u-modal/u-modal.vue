    ...
    <u-popup :zoom="zoom"
      ...
      <view class="u-model">
        <view v-if="showTitle"
              ...
              :style="[titleStyle]">{{ title }}</view>
        <view class="u-model__content">
          <view :style="[contentStyle]"
                v-if="$slots && ($slots.default  || $slots.$default)">
            <slot />
          </view>
          <view v-else
                class="u-model__content__message"
                :style="[contentStyle]">{{ content }}</view>
        </view>
        <view class="u-model__footer u-border-top"
          ...
          <view v-if="showConfirmButton || $slots['confirm-button']"
                ...
                @tap="confirm">
            <slot v-if="$slots['confirm-button']"
                  name="confirm-button"></slot>
            <block v-else>
              <u-loading mode="circle"
                         :color="confirmColor"
                         v-if="loading"></u-loading>
              <block v-else>
                {{confirmText}}
              </block>
            </block>
